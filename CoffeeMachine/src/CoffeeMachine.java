        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    do {
                        ...
                        if (espressoRoast.equals("light") || espressoRoast.equals("medium") || espressoRoast.equals("dark")) {
                            System.out.println("Invalid roast type. Please enter only: light, medium, or dark.");
                        } else {
                    ...
                    // TODO 8: Create an object of Espresso class using the parameterized construc
                    // TODO 8: Pass the espressoName, espressoRoast, espressoPrice, and numberOfShots as arguments in the correct order

                    Espresso myEspresso = new Espresso(espressoName,
                            espressoRoast, espressoPrice, numberOfShots);
                ...
                case 2:
                    ...
                    Latte myLatte = new Latte(latteName,
                            latteRoast, lattePrice, milkType, syrupFlavor);
